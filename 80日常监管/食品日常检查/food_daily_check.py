...
class FoodDailyCheck(object):
                        ...
                        for i in range(0, 5):
                            try:
                                ...
                                if data_exsists:
                                    ...
                                    if flag == 0:
                                        ture_or_false[i] = new_check_confirmer.confirm_new_check_check_template(check_describe)  # 共五个, checkTypeCode
                                    else:
                                        ture_or_false[i] = new_check_confirmer.confirm_new_check_check_situation(check_situation)
                                    driver.quit()
                                else:
    ...
    def normal_task(self):
        ...
        try:
            ...
            ture_or_false = new_normal_task_check_creater.confirm_normal_task_check(normal_plan_name, enterprise_name)
            driver.quit()
            return ture_or_false
        except Exception as e:
